										...
										Button(action: {
											...
											VStack {
												...
												if sharedMainViewModel.indexView == 0 {
													Text("bottom_navigation_contacts_label").default_text_style_700(styleSize: 10)
												} else {
								...
								ZStack {
									...
									VStack(spacing: 0) {
                                        ...
                                        if sharedMainViewModel.indexView == 0 {
                                             ...
                                             */
                                        }else if sharedMainViewModel.indexView == 5 {
											ContactsContainer(
...
struct DailPadContainer: View {
    @ObservedObject var vm: DialerViewModel     // ADD THIS
    var orientation: UIDeviceOrientation

    var body: some View {
        Group {
            DialpadFragment(vm: vm)             // FIXED
